...
public:
	...
	void Create()
	{
		worldOutliner.AddObject(new Canon(FPosition({ 1,1 }), "canon1", "¡Ü", "¡Û", Area({ 2,8 }), "¡Ü", "Canon"));
		worldOutliner.AddObject(new Canon(FPosition({ 5,1 }), "canon2", "¡Ü", "¡Û", Area({1,1}), "¡Ü", "Canon"));
		worldOutliner.AddObject(new Canon(FPosition({ 1,10 }), "canon3", "¡Ü", "¡Û", Area({10,1}), "¡Ü", "Canon"));
